          ...
          children: [
              ...
              children: [
                ...
                Text('Followers : ',
                    style: TextStyle(
                        ...
                        fontWeight: FontWeight.w500)),
                Text(
                  this.userStats.followers.toString(),
                  style: TextStyle(
            ...
            Row(
              children: [
                ...
                Text(
                  this.userStats.following.toString(),
                  style: TextStyle(
                      color: Colors.orange.shade900,
                      fontSize: 25,
                      fontWeight: FontWeight.w500),
            ...
            Row(
              children: [
                ...
                Text(
                  this.userStats.programs.toString(),
                  style: TextStyle(
                      color: Colors.orange.shade900,
                      fontSize: 25,
                      fontWeight: FontWeight.w500),
            ...
            Row(
              children: [
                ...
                Text(
                  this.userStats.competitions_entered.toString(),
                  style: TextStyle(
                      color: Colors.orange.shade900,
                      fontSize: 25,
                      fontWeight: FontWeight.w500),
            ...
            Row(
              children: [
                ...
                Text(
                  this.userStats.competitions_won.toString(),
                  style: TextStyle(
                      color: Colors.orange.shade900,
                      fontSize: 25,
                      fontWeight: FontWeight.w500),
            ...
            Row(
              children: [
                ...
                Text(
                  this.userStats.memberSince.substring(0, 10),
                  style: TextStyle(
                      color: Colors.orange.shade900,
                      fontSize: 25,
                      fontWeight: FontWeight.w500),
