                    ...
                    children: [
                      ...
                      TextFormField(
                        onChanged: (value) => setState(() {
                          _password = value;
                          authenticationController.signUp(UserSignUp(
                              email: _email,
                              username: _username,
                              password: _password,
                              picture: File('')));
                        ...
                        validator: (value) => value!.length < 8 ||
                                !value.contains(passwordRegEx1) ||
                                !value.contains(passwordRegEx2) ||
                                !value.contains(passwordRegEx3)
                      ...
                      FutureBuilder(
                          future: authenticationController.signUp(UserSignUp(
                              email: _email,
                              username: _username,
                              password: _password,
                              picture: File(''))),
